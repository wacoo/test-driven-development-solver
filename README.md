<center>
<h1>Test Driven Development Solver
</h1>
</center>
# 📗 Table of Contents
...
# 📖 Test Driven Development Solver <a name="about-project"></a>
In this project, we created a class based on the TDD approach. We added the tests first, made sure every test fails. Then added the class Solver and its methods making sure each item added passes the test.
...
- Fizzbuzz coding challenge method
...
```sh
  cd my-folder
  git clone https://github.com/Graciano1997/test-driven-development-solver.git
```
-
